...
export default {
    name: 'ChatLogisticsQuote',
    props: ["quote", "enquiry", "visibility"],
    data() {
        return {
            handler: null,
            userColors: {},
    ...
    methods: {
        ...
        welcomeMessages() {
            ...
            return [
                ...
                {
                    id: "quote",
                    user_id: self.quote.user_id,
                    created_at: self.quote.created_at,
                    message: `Price ${self.quote.price}, ${self.quote.comments}`,
                },
            ];
        },
        ...
        reload() {
            const self = this;
            api
                .loadLogisticsQuoteMessages(this.quote.id, {paginate: 0})
                .then((response) => {
        ...
        send(event) {
            ...
            api
                .storeLogisticsQuoteMessage(this.form, this.quote.id)
                .then((response) => {
                    self.reload();

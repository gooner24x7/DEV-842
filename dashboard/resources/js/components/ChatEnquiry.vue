...
export default {
    ...
    methods: {
        ...
        loadChats() {
          const self = this;
          api.loadEnquiryChats(this.enquiry.id, {paginate: 0})
            .then((response) => {
        ...
        reload() {
            ...
            api
                .loadEnquiryMessages(this.enquiry.id, {paginate: 0, userId: self.userId})
                .then((response) => {
        ...
        send(event) {
            ...
            api
                .storeEnquiryMessage(self.form, this.enquiry.id)
                .then((response) => {
                    self.reload();

...
return [
    ...
    */
    ...
    'url' => env('APP_URL', 'http://localhost/hire/dashboard'),

    'asset_url' => env('ASSET_URL', null),

    'sales_email_address' => env('SALES_EMAIL_ADDRESS', 'sales@thebuildchain.co.uk'),
    ...
    */
    ...
    'kafka_brokers'     => env('KAFKA_BROKERS', 'crm.ntuk.co.uk:9093'),
    'kafka_login'       => env('KAFKA_LOGIN', ''),
